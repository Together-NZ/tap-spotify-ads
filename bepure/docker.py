...
build_command = [
    ...
    "-t", "australia-southeast1-docker.pkg.dev/bepure-main/meltano/meltano-bepure-main:prod",
    "."
]
...
push_command = [
    "docker", "push",
    "australia-southeast1-docker.pkg.dev/bepure-main/meltano/meltano-bepure-main:prod"
]

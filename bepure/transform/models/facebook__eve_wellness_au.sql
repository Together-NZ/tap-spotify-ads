...
WITH ranked_data AS (
    ...
    FROM
        `bepure-main.facebook_raw__eve_wellness_au.ads_insights_action_video_type`
),
...
campaign_data AS (
    ...
    FROM `bepure-main.facebook_raw__eve_wellness_au.campaigns`
),
...
interest_data AS (
    ...
    FROM `bepure-main.facebook_raw__eve_wellness_au.ads`
),
...
device_data AS (
    ...
    FROM 
        `bepure-main.facebook_raw__eve_wellness_au.ads_insights_delivery_device`
),

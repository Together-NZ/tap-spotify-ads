...
funnel_campaign AS (
     select distinct funnel, campaign_name from `bepure-main.dash_table__eve_wellness.dash_union__eve_wellness`
),
dash AS (
     SELECT DISTINCT 
     ...
     FROM `bepure-main.dash_table__eve_wellness.dash_union__eve_wellness`
),
deduplicate_dash AS (

...
WITH ranked_data AS (
    ...
    FROM
        `bepure-main.facebook_raw__eve_wellness.ads_insights_action_video_type`
),
...
campaign_data AS (
    ...
    FROM `bepure-main.facebook_raw__eve_wellness.campaigns`
),
...
interest_data AS (
    ...
    FROM `bepure-main.facebook_raw__eve_wellness.ads`
),
...
device_data AS (
    ...
    FROM 
        `bepure-main.facebook_raw__eve_wellness.ads_insights_delivery_device`
),

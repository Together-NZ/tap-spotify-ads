...
where ad_stat.customer_id = 5775977318 and (lower(cam.publisher) not like '%search%' and lower(cam.publisher) not like '%performance max%')
GROUP BY 

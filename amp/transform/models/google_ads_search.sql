...
SELECT *,
CASE WHEN LOWER(publisher) = 'demand gen' and ARRAY_LENGTH(SPLIT(campaign_name,'_')) >=2 THEN SPLIT(campaign_name,'_')[OFFSET(1)]
ELSE campaign_name END AS campaign_name_selection
FROM publisher_data

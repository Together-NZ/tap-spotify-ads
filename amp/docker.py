...
build_command = [
    ...
    "-t", "australia-southeast1-docker.pkg.dev/amp-main/meltano/meltano-amp-main:prod",
    "."
]
...
push_command = [
    "docker", "push",
    "australia-southeast1-docker.pkg.dev/amp-main/meltano/meltano-amp-main:prod"
]

...
build_command = [
    ...
    "-t", "australia-southeast1-docker.pkg.dev/aia-nz-main/meltano/meltano-aia-main:prod",
    "."
]
...
push_command = [
    "docker", "push",
    "australia-southeast1-docker.pkg.dev/aia-nz-main/meltano/meltano-aia-main:prod"
]

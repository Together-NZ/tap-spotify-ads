...
WITH parsed_data AS (
    ...
    FROM
        `moe-main.dv360_raw.dv360_youtube`
)
...
SELECT
    ...
    CASE WHEN ARRAY_LENGTH(SPLIT(youtube_ad,'_')) < 8 THEN 'Other'
    ELSE SPLIT(youtube_ad,'_')[OFFSET(5)] END AS ad_format_detail,
    CASE WHEN ARRAY_LENGTH(SPLIT(youtube_ad,'_')) < 8 THEN 'Other'
    ELSE SPLIT(youtube_ad,'_')[OFFSET(7)] END AS creative_descr,

...
build_command = [
    ...
    "-t", "australia-southeast1-docker.pkg.dev/moe-main/meltano/meltano-moe-main:prod",
    "."
]
...
push_command = [
    "docker", "push",
    "australia-southeast1-docker.pkg.dev/moe-main/meltano/meltano-moe-main:prod"
]

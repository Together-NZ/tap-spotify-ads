...
build_command = [
    ...
    "-t", "australia-southeast1-docker.pkg.dev/ballance-main/meltano/meltano-ballance-main:prod",
    "."
]
...
push_command = [
    "docker", "push",
    "australia-southeast1-docker.pkg.dev/ballance-main/meltano/meltano-ballance-main:prod"
]

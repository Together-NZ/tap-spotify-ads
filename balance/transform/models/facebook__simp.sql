...
WITH ranked_data AS (
    ...
    FROM
        `ballance-main.facebook_raw__simp.ads_insights_action_video_type`
),
...
campaign_data AS (
    ...
    FROM `ballance-main.facebook_raw__simp.campaigns`
),
...
interest_data AS (
    ...
    FROM `ballance-main.facebook_raw__simp.ads`
),
...
device_data AS (
    ...
    FROM 
        `ballance-main.facebook_raw__simp.ads_insights_delivery_device`
),
...
FROM deplicate_data WHERE row_number = 1 and lower(campaign_name) like '%bal%'

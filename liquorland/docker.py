...
build_command = [
    ...
    "-t", "australia-southeast1-docker.pkg.dev/liquorland-main/meltano/meltano-liquorland-main:prod",
    "."
]
...
push_command = [
    "docker", "push",
    "australia-southeast1-docker.pkg.dev/liquorland-main/meltano/meltano-liquorland-main:prod"
]

...
SAFE_CAST(creative_descr AS STRING) AS creative_descr FROM `doconservation-main.dash_table.dash_table` ) UNION ALL (SELECT 
...
SAFE_CAST(video_views AS INT64) AS video_views,
SAFE_CAST(campaign_descr AS STRING) AS campaign_descr,
SAFE_CAST(creative_descr AS STRING) AS creative_descr FROM `doconservation-main.dash_table_search.dash_table_search` ) )
SELECT

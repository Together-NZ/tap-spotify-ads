...
build_command = [
    ...
    "-t", "australia-southeast1-docker.pkg.dev/zeekr-main/meltano/meltano-zeekr-main:prod",
    "."
]
...
push_command = [
    "docker", "push",
    "australia-southeast1-docker.pkg.dev/zeekr-main/meltano/meltano-zeekr-main:prod"
]

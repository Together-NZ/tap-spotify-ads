...
where ad_stat.customer_id = 8205744670 and (lower(cam.publisher) not like '%search%' and lower(cam.publisher) not like '%performance max%')
GROUP BY 

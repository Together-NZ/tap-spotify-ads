...
where ad_stat.customer_id = 6433737339  and (lower(cam.publisher) not like '%search%' and lower(cam.publisher) not like '%performance max%')
GROUP BY 

...
build_command = [
    ...
    "-t", "australia-southeast1-docker.pkg.dev/best-start-main/meltano/meltano-best-start-main:prod",
    "."
]
...
push_command = [
    "docker", "push",
    "australia-southeast1-docker.pkg.dev/best-start-main/meltano/meltano-best-start-main:prod"
]

...
build_command = [
    ...
    "-t", "australia-southeast1-docker.pkg.dev/volvo-main/meltano/meltano-volvo-main:prod",
    "."
]
...
push_command = [
    "docker", "push",
    "australia-southeast1-docker.pkg.dev/volvo-main/meltano/meltano-volvo-main:prod"
]

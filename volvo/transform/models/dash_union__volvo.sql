...
WITH final_result AS (
  {{ dash_table_general_process.dash_union_non_search(source_name='dash_union__volvo', table_name='dash_table__volvo',sub_brands=env_var('SUB_BRANDS', 'null')) }}
   UNION ALL 
   {{ dash_table_general_process.dash_union_search(source_name='dash_union_search__volvo', table_name='dash_table_search__volvo',sub_brands=env_var('SUB_BRANDS', 'null')) }}
 )
SELECT

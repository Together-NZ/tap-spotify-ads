...
build_command = [
    ...
    "-t", "australia-southeast1-docker.pkg.dev/polestar-main/meltano/meltano-polestar-main:prod",
    "."
]
...
push_command = [
    "docker", "push",
    "australia-southeast1-docker.pkg.dev/polestar-main/meltano/meltano-polestar-main:prod"
]

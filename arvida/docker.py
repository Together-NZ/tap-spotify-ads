...
build_command = [
    ...
    "-t", "australia-southeast1-docker.pkg.dev/arvida-main/meltano/meltano-arvida-main:prod",
    "."
]
...
push_command = [
    "docker", "push",
    "australia-southeast1-docker.pkg.dev/arvida-main/meltano/meltano-arvida-main:prod"
]

...
WITH final_result AS (
  {{ dash_table_general_process.dash_union_non_search(source_name='dash_union_non_search', table_name='dash_table') }}
   UNION ALL 
   {{ dash_table_general_process.dash_union_search(source_name='dash_union_search', table_name='dash_table_search') }}
 )
SELECT

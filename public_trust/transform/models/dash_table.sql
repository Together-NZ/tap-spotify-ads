...
WITH dash_table AS (
    ...
    FROM `public-trust-main.ttd_transformed.ttd`

    UNION ALL

    -- Handling Google Ads arrays by converting them to strings
    SELECT media_cost, impressions,  
           ad_name AS creative_name,   -- Convert array to string
           clicks,
    ...
    FROM `public-trust-main.google_ads_dv_transformed.google_ads_dv`
...
from `public-trust-main.cm360_transformed.cm360_direct_buy`
),
with_channel as (

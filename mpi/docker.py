...
build_command = [
    ...
    "-t", "australia-southeast1-docker.pkg.dev/mpi-main/meltano/meltano-mpi-main:prod",
    "."
]
...
push_command = [
    "docker", "push",
    "australia-southeast1-docker.pkg.dev/mpi-main/meltano/meltano-mpi-main:prod"
]

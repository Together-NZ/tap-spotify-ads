...
with models.DAG(
    ...
    kube_dash_union = KubernetesPodOperator(
            name="geely-dash-union-to-bigquery",
            task_id="geely-dash_union_to_bigquery",
            namespace="composer-user-workloads",
            image=IMAGE,
    ...
    kube_ttd = KubernetesPodOperator(
            name="geely-ttd-to-bigquery",
            task_id="geely-ttd_to_bigquery",
            namespace="composer-user-workloads",
            image=IMAGE,
...
with models.DAG(
    ...
    kube_google_ads_search = KubernetesPodOperator(
            name="geely-google-ads-search-to-bigquery",
            task_id="geely-google-ads-search_to_bigquery",
            namespace="composer-user-workloads",        
            image=IMAGE,
    ...
    kube_dash_search = KubernetesPodOperator(
            name="geely-dash-search-to-bigquery",
            task_id="geely-dash_search_to_bigquery",
            namespace="composer-user-workloads",
            image=IMAGE,

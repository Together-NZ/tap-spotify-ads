...
build_command = [
    ...
    "-t", "australia-southeast1-docker.pkg.dev/geely-main/meltano/meltano-geely-main:prod",
    "."
]
...
push_command = [
    "docker", "push",
    "australia-southeast1-docker.pkg.dev/geely-main/meltano/meltano-geely-main:prod"
]

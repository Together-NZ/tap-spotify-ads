...
WITH ad_stat_filtered_duplicate AS (
    ...
    FROM (
        ...
        FROM `uowaikato-main.snapchat_raw.ad_stats_daily`
    )
...
ad_details AS (
    ...
    FROM `uowaikato-main.snapchat_raw.ads`
),
...
ad_squad AS (
    ...
    FROM `uowaikato-main.snapchat_raw.ad_squads`
),
...
campaign AS (
    ...
    FROM `uowaikato-main.snapchat_raw.campaigns`
),

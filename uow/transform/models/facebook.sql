...
WITH ranked_data AS (
    ...
    FROM
        `uowaikato-main.facebook_raw.ads_insights_action_video_type`
),
...
campaign_data AS (
    ...
    FROM `uowaikato-main.facebook_raw.campaigns`
),
...
interest_data AS (
    ...
    FROM `uowaikato-main.facebook_raw.ads`
),
...
device_data AS (
    ...
    FROM 
        `uowaikato-main.facebook_raw.ads_insights_delivery_device`
),

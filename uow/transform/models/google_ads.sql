...
where ad_stat.customer_id = 7640236388 and (lower(cam.publisher) not like '%search%' and lower(cam.publisher) not like '%performance max%')
GROUP BY 

...
build_command = [
    ...
    "-t", "australia-southeast1-docker.pkg.dev/curative-main/meltano/meltano-curative-main:prod",
    "."
]
...
push_command = [
    "docker", "push",
    "australia-southeast1-docker.pkg.dev/curative-main/meltano/meltano-curative-main:prod"
]

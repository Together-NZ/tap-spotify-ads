...
WITH ranked_data AS (
    ...
    FROM
        `curative-main.facebook_creativenz_raw.ads_insights_action_video_type`
),
...
campaign_data AS (
    ...
    FROM `curative-main.facebook_creativenz_raw.campaigns`
),
...
interest_data AS (
    ...
    FROM `curative-main.facebook_creativenz_raw.ads`
),
...
device_data AS (
    ...
    FROM 
        `curative-main.facebook_creativenz_raw.ads_insights_delivery_device`
),
...
FROM deplicate_data WHERE row_number = 1 and lower(campaign_name) not like '%fas%'
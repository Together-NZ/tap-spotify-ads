...
WITH dash_table AS (
    ...
    FROM `curative-main.ttd_creativenz_transformed.ttd_creativenz_transformed`
    ...
    SELECT media_cost, impressions, clicks, creative_name, audience_name, ad_format, ad_format_detail, video_completion,video_25_completion,video_50_completion,video_75_completion,video_played AS video_views,
           campaign_name, publisher, campaign_descr, creative_descr, date(date) as date
    FROM `curative-main.facebook_creativenz_transformed.facebook_creativenz`
...
from `curative-main.cm360_creativenz_transformed.cm360_creativenz_direct_buy`
    UNION ALL
    ...
    SELECT media_cost, impressions, clicks, creative_name, audience_name, ad_format, ad_format_detail, video_completion
           ...
           campaign_name, publisher, campaign_descr, creative_descr, date(date) as date
    FROM `curative-main.tiktok_transformed__creativenz.tiktok__creativenz`
    UNION ALL
    ...
    SELECT media_cost, impressions, clicks, creative_name, audience_name, ad_format, ad_format_detail, video_completion,video_25_completion,video_50_completion,video_75_completion, video_25_completion as video_views,
           campaign_name, publisher, campaign_descr, creative_descr, date(date) as date
    FROM `curative-main.dv360_creativenz_transformed.dv360_creativenz_standard`
    
    UNION ALL
    SELECT media_cost, impressions, clicks, creative_name, audience_name, ad_format, ad_format_detail, video_completion,video_25_completion,video_50_completion,video_75_completion, video_25_completion as video_views,
           campaign_name, publisher, campaign_descr, creative_descr, date(date) as date
    FROM `curative-main.dv360_creativenz_transformed.dv360_creativenz_youtube`
    UNION ALL
    ...
    FROM `curative-main.google_ads_creativenz_search_transformed.google_ads_demand__creativenz`
), with_channel AS (

...
build_command = [
    ...
    "-t", "australia-southeast1-docker.pkg.dev/brightr-main/meltano/meltano-brightr-main:prod",
    "."
]
...
push_command = [
    "docker", "push",
    "australia-southeast1-docker.pkg.dev/brightr-main/meltano/meltano-brightr-main:prod"
]

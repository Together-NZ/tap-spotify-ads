...
with models.DAG(
    ...
    def set_env_vars_google_ads_search():
        ...
        env["DBT_BIGQUERY_PROJECT"] = 'brightr-main'
    ...
    kube_google_ads_search = KubernetesPodOperator(
        name="brightr-google-ads-search-to-bigquery",
        task_id="brightr-google_ads_search_to_bigquery",
        namespace="composer-user-workloads",
        image=IMAGE,
    ...
    kube_ga4 = KubernetesPodOperator(
        name="brightr-ga4-to-bigquery",
        task_id="brightr-ga4_to_bigquery",
        namespace="composer-user-workloads",
        image=IMAGE,
    ...
    set_env_task_google_ads_search >> kube_google_ads_search >> set_env_task_dash >> kube_dash 
...
with models.DAG(
    ...
    kube_linkedin = KubernetesPodOperator(
        name = "brightr-linkedin-transformation",
    ...
    kube_hivestack = KubernetesPodOperator(
        name = "brightr-hivestack-transformation",
        task_id = "brightr-hivestack_transformation",
        namespace="composer-user-workloads",
        image=IMAGE,
    ...
    kube_cm360 = KubernetesPodOperator(
        name="brightr-cm360-transformation",
        task_id = "brightr-cm360_transformation",
        namespace="composer-user-workloads",
        image=IMAGE,
    ...
    [kube_facebook,kube_ttd,kube_linkedin,kube_cm360,kube_hivestack] >> kube_dash

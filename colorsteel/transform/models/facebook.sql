...
WITH ranked_data AS (
    ...
    FROM
        `colorsteel-main.facebook_raw.ads_insights_action_video_type`
),
...
campaign_data AS (
    ...
    FROM `colorsteel-main.facebook_raw.campaigns`
),
...
device_data AS (
    ...
    FROM 
        `colorsteel-main.facebook_raw.ads_insights_delivery_device`
),

...
build_command = [
    ...
    "-t", "australia-southeast1-docker.pkg.dev/colorsteel-main/meltano/meltano-colorsteel-main:prod",
    "."
]
...
push_command = [
    "docker", "push",
    "australia-southeast1-docker.pkg.dev/colorsteel-main/meltano/meltano-colorsteel-main:prod"
]

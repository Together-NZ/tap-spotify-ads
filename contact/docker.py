...
build_command = [
    ...
    "-t", "australia-southeast1-docker.pkg.dev/contact-energy-main/meltano/meltano-contact-main:prod",
    "."
]
...
push_command = [
    "docker", "push",
    "australia-southeast1-docker.pkg.dev/contact-energy-main/meltano/meltano-contact-main:prod"
]

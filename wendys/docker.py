...
build_command = [
    ...
    "-t", "australia-southeast1-docker.pkg.dev/wendys-main/meltano/meltano-wendys-main:prod",
    "."
]
...
push_command = [
    "docker", "push",
    "australia-southeast1-docker.pkg.dev/wendys-main/meltano/meltano-wendys-main:prod"
]

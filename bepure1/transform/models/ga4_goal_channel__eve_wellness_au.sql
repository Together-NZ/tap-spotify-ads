...
funnel_campaign AS (
     select distinct funnel, campaign_name from `bepure-main.dash_table__eve_wellness_au.dash_union__eve_wellness_au`
),
dash AS (
     SELECT DISTINCT 
     ...
     FROM `bepure-main.dash_table__eve_wellness_au.dash_union__eve_wellness_au`
),
deduplicate_dash AS (

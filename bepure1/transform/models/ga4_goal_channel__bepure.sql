...
funnel_campaign AS (
     select distinct funnel, campaign_name from `bepure-main.dash_table__bepure.dash_union__bepure`
),
dash AS (
     SELECT DISTINCT 
     ...
     FROM `bepure-main.dash_table__bepure.dash_union__bepure`
),
deduplicate_dash AS (

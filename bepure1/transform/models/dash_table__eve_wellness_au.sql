...
WITH dash_table AS (
    ...
    FROM `bepure-main.facebook_transformed__eve_wellness_au.facebook__eve_wellness_au`
    UNION ALL
    ...
    FROM `bepure-main.google_ads_search_transformed__eve_wellness_au.google_ads_demand__eve_wellness_au`
),
with_channel as (

...
build_command = [
    ...
    "-t", "australia-southeast1-docker.pkg.dev/tepuia-main/meltano/meltano-tepuia-main:prod",
    "."
]
...
push_command = [
    "docker", "push",
    "australia-southeast1-docker.pkg.dev/tepuia-main/meltano/meltano-tepuia-main:prod"
]

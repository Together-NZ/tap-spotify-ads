...
WITH dash_table AS (
    ...
    FROM `ballance-main.ttd_transformed.ttd_transformed`
    ...
    SELECT media_cost, impressions, clicks, creative_name, audience_name, ad_format, ad_format_detail, video_completion,video_25_completion,video_50_completion,video_75_completion, video_25_completion as video_views,
           campaign_name, publisher, campaign_descr, creative_descr, date(date) as date
    FROM `ballance-main.dv360_transformed.dv360_standard`
    
    UNION ALL
       SELECT media_cost, impressions, clicks, creative_name, audience_name, ad_format, ad_format_detail, video_completion,video_25_completion,video_50_completion,video_75_completion, video_25_completion as video_views,
           campaign_name, publisher, campaign_descr, creative_descr, date(date) as date
    FROM `ballance-main.dv360_transformed.dv360_youtube`
    UNION ALL
    ...
    FROM `ballance-main.google_ads_search_transformed.google_ads_demand`
    UNION ALL
    ...
    FROM `ballance-main.google_ads_dv_transformed.google_ads_dv`
    UNION ALL
    SELECT media_cost, impressions, clicks, creative_name, audience_name, ad_format, ad_format_detail, video_completion,video_25_completion,video_50_completion,video_75_completion,video_played AS video_views,
           campaign_name, publisher, campaign_descr, creative_descr, date(date) as date
    FROM `ballance-main.facebook_transformed__brand.facebook__brand`

    UNION ALL
    SELECT media_cost, impressions, clicks, creative_name, audience_name, ad_format, ad_format_detail, video_completion,video_25_completion,video_50_completion,video_75_completion,video_played AS video_views,
           campaign_name, publisher, campaign_descr, creative_descr, date(date) as date
    FROM `ballance-main.facebook_transformed__simp.facebook__simp`
    UNION ALL
...
from `ballance-main.cm360_transformed.cm360_direct_buy`
),
with_channel as (
...
WHERE LOWER(campaign_name) like '%bal%'),
campaign_base AS (
       SELECT *,

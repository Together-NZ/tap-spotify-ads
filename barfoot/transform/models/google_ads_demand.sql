...
where ad_stat.customer_id = 4183543527 and (lower(cam.publisher) not like '%search%' and lower(cam.publisher) not like '%performance max%')
GROUP BY 

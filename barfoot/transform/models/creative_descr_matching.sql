UPDATE `barfoot-and-thompson-main.ga4_transformed.ga4_goal_channel` AS ga4
...
FROM (
  WITH dash AS (
    ...
    FROM `barfoot-and-thompson-main.dash_table.dash_union`
  ),
  deduplicate_dash AS (
  ...
  ga4_tmp AS (
    ...
    FROM `barfoot-and-thompson-main.ga4_transformed.ga4_goal_channel`
  ),
  deduplicate_ga4 AS (

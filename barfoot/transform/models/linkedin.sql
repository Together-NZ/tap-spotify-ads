...
date FROM `together-internal.linkedin_transformed.linkedin` where  advertiser_account_id = '510105965' group by date,campaign_name,media_format,campaign_descr,ad_format,ad_format_detail,publisher,audience_name,creative_name,creative_descr,advertiser_account_id
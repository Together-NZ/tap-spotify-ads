...
build_command = [
    ...
    "-t", "australia-southeast1-docker.pkg.dev/farizon-main/meltano/meltano-farizon-main:prod",
    "."
]
...
push_command = [
    "docker", "push",
    "australia-southeast1-docker.pkg.dev/farizon-main/meltano/meltano-farizon-main:prod"
]

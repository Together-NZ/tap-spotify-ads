...
IMAGE = "australia-southeast1-docker.pkg.dev/farizon-main/meltano/meltano-farizon-main:prod"
...
def get_meltano_env():
    ...
    meltano_env_unique = Variable.get("meltano_farizon_main", deserialize_json=True)
...
with models.DAG(
    dag_id="farizon-meltano-google_ads",
    ...
    def set_env_vars_google_ads_search():
        ...
        env["DBT_BIGQUERY_PROJECT"] = 'farizon-main'
    ...
    kube_google_ads_search = KubernetesPodOperator(
            name="farizon-google-ads-search-to-bigquery",
            task_id="farizon-google-ads-search_to_bigquery",
    ...
    kube_dash_search = KubernetesPodOperator(
            name="farizon-dash-search-to-bigquery",
            task_id="farizon-dash_search_to_bigquery",
            namespace="composer-user-workloads",
            image=IMAGE,
    ...
    kube_ga4 = KubernetesPodOperator(
            name="farizon-ga4-to-bigquery",
            task_id="farizon-ga4_to_bigquery",
            namespace="composer-user-workloads",
            image=IMAGE,
    ...
    kube_dash = KubernetesPodOperator(
            name="farizon-dash-to-bigquery",
            task_id="farizon-dash_to_bigquery",
            namespace="composer-user-workloads",
            image=IMAGE,
    ...
    kube_dash_union = KubernetesPodOperator(
            name="farizon-dash-union-to-bigquery",
            task_id="farizon-dash_union_to_bigquery",
            namespace="composer-user-workloads",
            image=IMAGE,

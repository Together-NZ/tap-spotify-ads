...
IMAGE = "australia-southeast1-docker.pkg.dev/squirrel-together-main/meltano/meltano-squirrel-main:prod"
...
with models.DAG(
    ...
    [kube_facebook,kube_ttd,kube_tiktok,kube_hivestack,kube_cm360,kube_dv360]>>kube_dash>>kube_dash_union